...
#####
## Explaining how to code the game
    # Give the rules to the user
    # Take the user guess
    # Check if the first letter is right
    # Check if the first letter is in the right spot
    ...
    # Check if the user guesses the correct word 
    # If correct congratulate them, if not tell them to try again
    # Repeat the process for a total of 6 guesses
    # Let the user know the game is over whether they guess the word or take all 6 guesses

# Explaining the rules to the user
print("Welcome to Wordle, the rules to the game are simple: \nYou get 6 guesses to guess the word that The Wordler is thinking of. \nThe Wordler will tell you give you information about each of your guesses. \nHe will tell you which letters in your guess exist \nHe will tell you if those letters are in the correct place . \nHe will tell you which letters in your guess do not exist. \nYou must use your logical deduction skills to beat The Wordler, good luck!\n\n\n")
